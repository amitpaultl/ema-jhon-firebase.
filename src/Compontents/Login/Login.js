...
const Login = () => {
    const {signInWith, user} = useContext(Athcontext);
    ...
    const submitHandaler = (e)=>{
        ...
        const passwaord = fom.password.value;

        signInWith(email, passwaord)
        .then((userCredential) => {
    ...
    return (
        <div className='from'>
            ...
            <form onSubmit={submitHandaler}> 
                ...
                <button className='submit' type='submit'>Sing in</button>
            </form>
